...
class TestCoupon(BalancedTransactionalTestCase):
    ...
    def test_expire(self):
        ...
        Coupon.create(your_id=self.your_id,
                      group_id=self.group,
                      name='My Coupon',
                      price_off_cents=20,
                      percent_off_int=1,
        ...
        with freeze_time('2013-6-25'):
            ...
            self.assertEqual(Coupon.retrieve(self.your_id,
                                             self.group).active,
                             True)
    ...
    def test_expire_multiple(self):
        ...
        Coupon.create(your_id='MY_TEST_COUPON2',
                      group_id=self.group,
                      name='My Coupon 2',
                      price_off_cents=20,
                      percent_off_int=1,
...
class TestCreate(TestCoupon):
    ...
    def test_create_semi_colliding(self):
        """
        Collides on your_id but not marketplace. Should work.
        """
        now = datetime.utcnow()
        Coupon.create(your_id=self.your_id,
                      group_id=self.group,
        ...
        Coupon.create(your_id=self.your_id,
                      ...
                      repeating=-1,
                      expire_at=now)
        ret = Coupon.retrieve(self.your_id, self.group)
        self.assertEqual(ret.price_off_cents, 100)
        ret = Coupon.retrieve(self.your_id, self.group_2)
...
class TestRetrieve(TestCoupon):
    ...
    def test_create_and_retrieve(self):
        ...
        ret_coupon = Coupon.retrieve(self.your_id, self.group)
    ...
    def test_retrieve_params(self):
        with freeze_time('2016-7-1'):
            ...
            coupon = Coupon.create(your_id=self.your_id,
                                   ...
                                   expire_at=now)
            ret = Coupon.retrieve(self.your_id, self.group)
            self.assertEqual(ret.your_id, self.your_id)
    ...
    def test_retrieve_active_only(self):
        ...
        Coupon.retrieve(self.your_id, self.group)
        coupon.delete()
        with self.assertRaises(NoResultFound):
            Coupon.retrieve(self.your_id, self.group,
                            active_only=True)
...
class TestUpdateDelete(TestCoupon):
    ...
    def test_update(self):
        now = datetime.utcnow()
        coup = Coupon.create(your_id='MY_TEST_COUPON1',
                             group_id=self.group,
                             name='My coupon',
                             price_off_cents=20,
                             percent_off_int=1,
    ...
    def test_delete(self):
        ...
        coup = Coupon.retrieve(self.your_id, self.group)
...
class TestValidators(TestCoupon):
    ...
    def test_max_redeem_(self):
        with self.assertRaises(ValueError):
            Coupon.create(your_id='MY_TEST_COUPON1',
                          group_id=self.group,
                          name='My coupon',
                          price_off_cents=20,
                          percent_off_int=1,
