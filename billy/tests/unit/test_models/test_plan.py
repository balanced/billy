...
class TestPlanModel(ModelTestCase):
    ...
    def test_get_plan(self):
        plan = self.plan_model.get('PL_NON_EXIST')
        self.assertEqual(plan, None)

        with self.assertRaises(KeyError):
            self.plan_model.get('PL_NON_EXIST', raise_error=True)
    ...
    def test_update_with_wrong_args(self):
        ...
        with self.assertRaises(TypeError):
            self.plan_model.update(guid, wrong_arg=True, neme='john')
