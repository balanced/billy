...
class IntegrationTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.target_url = os.environ.get('BILLY_TEST_URL', 'http://127.0.0.1:6543#requests')
        self.processor_key = os.environ.get('BILLY_TEST_PROCESSOR_KEY', 'ef13dce2093b11e388de026ba7d31e6f')
